...
```xml
    <param name="markers_sep_x" value="0.97"/> <!-- расстояние между маркерами по горизонтали -->
    <param name="markers_sep_y" value="1.435"/> <!-- расстояние между маркерами по вертикали -->
```
