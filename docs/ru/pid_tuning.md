...
В этой статье описаны методы и основные технологии настройки каскадного ПИД-регулятора. Приведенные советы и методики подходят для любых видов рам (Квадрокоптеров, Гексокоптеров, Октокоптеров и т.д.). Оригинал статьи смотрите [в источнике](https://docs.px4.io/v1.9.0/en/config_mc/pid_tuning_guide_multicopter.html).
...
## Настройки для комплектов Клевер 4/Клевер 3

Ниже приведены усредненные параметры для комплектов Клевер 4 и Клевер 3.

>> **Caution** Данные настройки не являются идеальными и не гарантируют вам наилучший полет. Каждый собранный аппарат немного отличен от остальных, по причине заводских погрешностей инерциальных систем навигации установленных на дроне, а также особенностей сборки того или иного аппарата. С совокупности эти факторы сильно влияют на окончательные параметры ПИД регулятора.
