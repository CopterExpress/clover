...
- Подключиться к Wi-Fi и зайти в веб-интерфейс:
...
- Подключиться к Raspberry Pi по SSH.
  ...
  Рекомендуем использовать веб-доступ. Для этого следуйте инструкциям в соответствующем разделе статьи:
...
- Убедиться в корректной работе камеры. 
  ...
  Более подробно можно прочитать в статье в разделе «Просмотр»:
