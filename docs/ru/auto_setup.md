...
- Установите Raspberry Pi и камеру на квадрокоптер по [инструкции](assemble_3.md/#Монтаж_Raspberry) в разделе "Монтаж Raspberry".
...
### Базовые команды для работы в командной строке Linux:
