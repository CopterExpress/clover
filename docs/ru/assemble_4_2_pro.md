...
Установите верхнюю деку. Установите 4 нейлоновых стойки 40мм, вставьте малую монтажную деку вертикально и зафиксируйте сверху еще одноуй монтажной декой, как показано на фотографии.
...
<img src="../assets/gps/gps_1.jpg" width=300 class="zoom border">

Подключите приемник в разъем GPS полетного контроллера, и зафиксируйте кабель при помощи стяжки.

<img src="../assets/gps/gps_2.jpg" width=300 class="zoom border">
