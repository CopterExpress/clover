...
Инфракрасные датчики удобный инструмент для передачи каких либо управляющих воздействий на ваш коптер. Они поддерживают полную гибкость настройки и поддерживают использование в языке `python`.
