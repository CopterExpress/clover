...
1. Закрепите поликарбонатные ремнакладки на пластинах жесткости.
...
3. Переключатели A, B, C, D в положение **"от себя"**.
    ...
    <img src="../assets/4/base.png" alt="Нейтральное положение стиков пульта" class="zoom center" width=500>
