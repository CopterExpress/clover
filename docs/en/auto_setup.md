...
The easiest way to send the program is to copy the content of the program, create a new file on the Clover command line and paste the program text into the file.
