...
4. Connect the center leg of the transistor to the leg of the Schottky diode (opposite to the gray marking strip).
...
To control the capture in manual mode, it can be connected to the Arduino Nano board.
