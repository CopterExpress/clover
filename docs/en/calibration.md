...
> **Caution** If you use the flight controller [*COEX Pix*](coex_pix.md), and it installed with servo pins faced backwards, all *Autopilot Orientation* columns must specify `ROTATION_ROLL_180_YAW_90`, otherwise the flight controller will not correctly perceive the tilt and rotation of the copter.
