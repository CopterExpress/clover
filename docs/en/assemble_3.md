...
5. Solder two additional wires to the BEC
    ...
    * The red and black wires [are to be blanched](tinning) on both ends using tweezers. The blue wire is to be blanched from the side of the MALE connector.
...
7. Installation of the LED strip.
    ...
    * [Blanch](tinning) the contacts of the LED strip.
