...
Зачистить (снять 2мм термоизоляции с конца провода, не повредив медные жилы).
Скрутить провода.
Залудить (Нанести флюс на оголенную часть провода. Покрыть припоем.), используя пинцет.

![лужениче](../img/zap.img)
